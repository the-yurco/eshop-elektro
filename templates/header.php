...
<html>
<head>
<title>Elektro Eshop | Domovská stránka</title>
<link href="css/bootstrap.css" rel='stylesheet' type='text/css' />
<!-- jQuery (nevyhnutný pro JavaScriptové pluginy Bootstrapu) -->
<script src="js/jquery.min.js"></script>
<!-- Vlastní soubory tématu -->
<link href="css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- Vlastní soubory tématu -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Elektro Eshop, Bootstrap webové šablony, ploché webové šablony, webové šablony kompatibilní s Androidem, webové šablony kompatibilní se smartphony, zdarma webové designy pro Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
<!-- Webový font -->
<!-- Pro práci s Bootstrapem -->
